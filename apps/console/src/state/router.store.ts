...
export type Route = 'canon' | 'principals' | 'activities' | 'plans' | 'graph' | 'timeline' | 'plan-lifecycle' | 'deliberation';

const DEFAULT: Route = 'canon';
const VALID: ReadonlyArray<Route> = ['canon', 'principals', 'activities', 'plans', 'graph', 'timeline', 'plan-lifecycle', 'deliberation'];
