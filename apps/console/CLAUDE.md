...
- `lag ps` or equivalent: know what processes are already running (dashboard port 9080, backend port 9081) — never start a second instance from a different worktree.
