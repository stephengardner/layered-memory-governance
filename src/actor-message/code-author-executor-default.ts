// Compatibility shim: moved to src/runtime/actor-message/code-author-executor-default.ts as
...
export * from '../runtime/actor-message/code-author-executor-default.js';
