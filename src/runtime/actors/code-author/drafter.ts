...
export const DRAFT_SYSTEM_PROMPT = [
  ...
  '    Grep on the plan\'s prose-referenced concepts (route patterns, component or',
  '    module names, endpoint paths, identifiers) to locate candidate files in the',
  '    working tree. Only after those queries return zero matches, OR after candidate',
  '    files exist but the requested change cannot be made against them, may you',
  '    escalate via empty-diff with `confidence` below 0.5 and a `notes` body that',
  '    lists the queries you ran and what they returned. Do not hallucinate a project',
  '    name or working-directory identity; ground every claim about repo contents in a',
  '    tool-call result.',
  '',
  'File context:',
