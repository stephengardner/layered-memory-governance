...
function parseResultMessage(
  ...
  // same string we just emitted as finalText. Without this the caller
  // reads the last assistant delta from the accumulator instead of
  // the canonical result envelope text.
