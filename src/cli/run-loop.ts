...
function printUsage(): void {
  console.error(
    [
      ...
      '                                 state on PRs that transitioned since the last',
      '                                 observation. Bounded by an in-tick refresh cap.',
      '                                 Explicit form -- always wins when passed.',
      '  --no-refresh-plan-observations Disable the refresh pass. Explicit form -- always wins',
      '                                 when passed.',
      '  (default when neither flag is passed) Read from the canon policy atom',
      '                                 pol-loop-pass-pr-observation-refresh-default; falls',
      '                                 back to true when the atom is absent. The CLI flag',
      '                                 always overrides the canon value when explicitly passed.',
