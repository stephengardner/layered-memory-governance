...
// Honor LAG_STATE_DIR via resolveStateDir so a deployment that points
// the rest of the substrate at a different state path does not silently
// fork its canon between the env-pointed dir and REPO_ROOT/.lag.
// Indie-floor default (env unset) is the in-repo path; org-ceiling
// deployments set LAG_STATE_DIR once and every bootstrap + runtime
// path agrees.
